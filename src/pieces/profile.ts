...
export class Profile {
          ...
          <div class="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12">
            ...
            <div class="flex-grow space-y-8 w-full">
              <div class="space-y-6">
                ...
                <p class="text-lg text-text/80 leading-relaxed text-center md:text-left">
                  ...
                  <a href="https://plato5.us/about/how-social-engines-can-solve-the-loneliness-epidemic" 
                     class="text-blue-500 hover:text-blue-600 transition-colors duration-300 ml-1"
                     target="_blank"
              ...
              <div class="flex flex-wrap justify-center md:justify-start gap-2">
                <button 
                  class="text-sm text-text hover:text-primary transition-colors duration-300"
    ...
    private setupEventListeners(): void {
      const skillsContent: Record<string, string> = {
        'Consulting': `
          <h3 class="text-2xl font-heading mb-4">Consulting Experience</h3>
        ...
        `,
        'IT Troubleshooting': `
          <h3 class="text-2xl font-heading mb-4">IT Troubleshooting</h3>
          <p class="text-text/80 leading-relaxed mb-4">
        ...
        `,
        'Flutter': `
          <h3 class="text-2xl font-heading mb-4">Flutter Development</h3>
          <p class="text-text/80 leading-relaxed mb-4">
        ...
        `,
        'Go': `
          <h3 class="text-2xl font-heading mb-4">Go Development</h3>
          <p class="text-text/80 leading-relaxed mb-4">
        ...
        `,
        'TypeScript': `
          <h3 class="text-2xl font-heading mb-4">TypeScript Development</h3>
          <p class="text-text/80 leading-relaxed mb-4">
        ...
        `,
        'PostgreSQL': `
          <h3 class="text-2xl font-heading mb-4">PostgreSQL</h3>
          <p class="text-text/80 leading-relaxed mb-4">
        ...
        `,
        'Cloud': `
          <h3 class="text-2xl font-heading mb-4">Cloud Computing</h3>
          <p class="text-text/80 leading-relaxed mb-4">
        ...
        `,
        'AI': `
          <h3 class="text-2xl font-heading mb-4">AI Integration</h3>
          <p class="text-text/80 leading-relaxed mb-4">
        ...
        `,
        'Marketing': `
          <h3 class="text-2xl font-heading mb-4">Marketing Experience</h3>
          <p class="text-text/80 leading-relaxed mb-4">
